...
const Header = () => {
  return (
    ...
    <header className='header-top-strip py-3'>
        <div className='container-xxl'>
            <div className='row'>
                ...
                <div className='col-6'>
                    <p className='text-end text-white mb-0'>Hotline: <a className='text-white' href='tel:+91 7982770894'>+91 7982770894</a></p>
                </div>
            </div>
        </div>
    ...
    <header className='header-upper py-3'>
        <div className='container-xxl'>
            ...
            <span className="input-group-text p-3" id="basic-addon2"><BsSearch className='5'/></span>
            </div>
            </div>
            <div className='col-5'>
                <div className='header-upper-links d-flex align-items-center justify-content-between'>
                    ...
                    <Link to='/cart' className='d-flex align-items-center gap-10 text-white'>
                        <img src='images/cart.svg' height={50} width={50} alt=''/>
  ...
  <button class="btn btn-secondary dropdown-toggle bg-transparent border-0 me-5 gap-15 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    <img src="images/menu.svg" width={45} height={45} alt=""/> <span className='me-5 d-inline-block'>Shop Categories</span>
  </button>
